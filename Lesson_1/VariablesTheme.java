public class VariablesTheme {
    public static void main(String[] args) {
     ...
     System.out.println("\n" + space + space + space + space 
        + slash + backslash + space + space + space + space);
     System.out.println("" + space + space + space 
        + slash + space + space + backslash + space + space + space);
     System.out.println("" + space + space + slash + underscope + oParenthesis + space + cParenthesis + backslash + space + space);
     System.out.println("" + space + slash + space + space + space + space + space + space 
        + backslash + space);
     System.out.println("" + slash + underscope + underscope + underscope + underscope + slash + backslash + underscope + underscope + backslash + "");  
